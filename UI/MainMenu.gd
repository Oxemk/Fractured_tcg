...
func _on_shop() -> void:
	get_tree().change_scene_to_file("res://Scenes/MainMenu/shop_%s.tscn" % Globals.current_mode.capitalize())

func _on_collection() -> void:
	get_tree().change_scene_to_file("res://Scenes/MainMenu/CardCollection_%s.tscn" % Globals.current_mode.capitalize())
